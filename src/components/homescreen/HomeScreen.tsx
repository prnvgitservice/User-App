...
interface Category {
  ...
  status: number; // 1 = popular, 0 = other
}
...
const HomeScreen = () => {
  const navigation = useNavigation<any>(); // 👈 Fix for navigation type
  ...
  return (
    <ScrollView className="flex-1 bg-white px-4">
      ...
      <View className="flex-row items-center mt-6 mb-4">
        ...
        <View className="ml-4 flex-1">
          <Text className="text-gray-500 text-base">
            Good Morning <Text className="text-lg">👋</Text>
          </Text>
          <Text className="text-lg font-bold text-gray-900">Andrew Ainsley</Text>
        </View>
      </View>
      ...
      <View className="flex-row items-center bg-gray-100 rounded-2xl px-4 mb-6">
        ...
        />
        <Ionicons name="search" size={22} color="#a259ff" />
      </View>
        ...
        {allCategories
          ...
          .map((category) => {
            ...
            return (
              <TouchableOpacity
                key={category._id}
                className="w-[48%] bg-white rounded-2xl p-4 mb-4 border border-gray-200 shadow-sm"
                onPress={() => navigation.navigate('Technicians', { id: category._id })}
              >
                <View
                  className={`w-20 h-20 ${bgColor} rounded-full flex items-center justify-center self-center mb-3`}
                >
                  <Image
      ...
      {/* --- Other Categories --- */}
      <Text className="text-lg font-bold text-gray-900 mb-3">Other Categories</Text>
